...
@login_required(login_url='adminlogin')
def admin_combined_view(request):
    students = SMODEL.Student.objects.all()
    courses = models.Course.objects.all()
    ...
    for student in students:
        for course in courses:
            results = models.Result.objects.filter(student=student, exam=course)
            if results.exists():
    ...
    return render(request, 'quiz/admin_combined_view.html', context)
