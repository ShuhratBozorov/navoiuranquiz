...
path('teacher-combined-view/', views.teacher_combined_view, name='teacher_combined_view_no_pk'),
path('update-question/<int:pk>', views.update_question_view,name='update-question'),
path('detail-question/<int:pk>', views.detail_question_view,name='detail-question'),
]